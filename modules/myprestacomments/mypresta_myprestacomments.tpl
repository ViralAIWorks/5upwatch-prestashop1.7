    ...
    {if isset($myprestacomments_product) && $myprestacomments_product}
        ...
        <div style="display:none">
            <div id="new_comment_form">
                {if $reviewsForCustomers == 1 AND $reviewsForCustomersPurchased == 1}
                <form id="id_new_comment_form" action="" enctype="multipart/form-data">
                    ...
                    <div class="new_comment_form_content">
                        ...
                        {hook h='displayMyPrestaCommentsFields' product=$myprestacomments_product}
                ...
                {else}
                    <p class="alert alert-warning">{l s='Reviews can be placed by customers that purchased this product' mod='myprestacomments'}</p>
                {/if}
            </div>
        </div>
        <!-- End fancybox -->
