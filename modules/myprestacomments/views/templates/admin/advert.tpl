...
<div class="panel">
    ...
    <ul>
        ...
        <li><a href="https://mypresta.eu/modules/administration-tools/dashboard-comments-reviews-moderation.html" target="_blank">{l s='Moderate comments on shop\'s dashboard' mod='myprestacomments'}</a></li>
        <li><a href="https://mypresta.eu/modules/front-office-features/add-pictures-to-product-comments-reviews.html" target="_blank">{l s='Add pictures to product comments' mod='myprestacomments'} <span class="label label-danger">{l s='NEW!' mod='myprestacomments'}</span></a></li>
    </ul>
</div>